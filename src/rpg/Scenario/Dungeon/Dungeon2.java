    ...
    protected Attributes createEnemy(Attributes personagem) {
        if (personagem.getLevel() >= 10) {
            ...
            return switch (randomMonster) {
                case 0 -> new Mob("Carniçal", 80, 15, 25, "GRAAAAAAAA!", 20, 20);
                case 1 -> new Mob("Lobisomen", 110, 27, 12, "ARRGH!", 25, 25);
                case 2 -> new Mob("Oni", 90, 40, 0, "Me de sua alma!", 30, 30);
                case 3 -> new Mob("Cavalo Infernal", 70, 25, 30, "IIIHAIA", 25, 25);
                case 4 -> new Mob("Aranha Gigante", 75, 17, 20, "IPIPPPPI", 18, 18);
                default -> new Mob("Carniçal", 80, 15, 25, "GRAAAAAAAA!", 20, 20);
            };
        }
    }
