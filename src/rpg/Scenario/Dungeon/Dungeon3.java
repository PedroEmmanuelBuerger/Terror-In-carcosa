    ...
    protected Attributes createEnemy(Attributes personagem) {
        if (personagem.getLevel() >= 20) {
            ...
            return switch (randomMonster) {
                case 1 -> new Mob("Ciclope", 150, 40, 8, "Estou te vendo!", 50, 50);
                case 2 -> new Mob("Observador", 170, 25, 30, "Seja reduzido a Pó", 65, 65);
                case 3 -> new Mob("Cervo Demoniaco", 130, 50, 15, "Te levarei até o inferno!", 60, 60);
                case 4 -> new Mob("Cavaleiro Corrompido", 180, 30, 30, "Servirei a Taigon até o fim!", 85, 85);
                default -> new Mob("Golem", 120, 30, 20, "Meu dever!", 40, 40);
            };
        }
    }
