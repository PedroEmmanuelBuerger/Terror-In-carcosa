...
import rpg.Monsters.Minions.MindEater;
...
public class Dungeon1 extends DungeonBase {
    ...
    protected Attributes createEnemy(Attributes personagem) {
        if (personagem.getLevel() >= 5) {
            ...
            int randomMonster = random.nextInt(6);
            Mob mob;
            switch (randomMonster) {
                ...
                case 5 -> mob = new MindEater("Consumidor de mentes", 100, 20, 40, "Sua mente é minhaAaAaAaA", 25, 70, Portraits.PortraitDemonioDoCaos());
