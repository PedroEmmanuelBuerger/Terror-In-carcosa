...
public class CreateWarrior {
    public static Warrior createWarrior(Scanner scanner) {
        ...
        do {
            ...
            System.out.println("Digite o valor da vida inicial do Guerreiro (máximo " + maxPoints + "):");
            ...
            System.out.println("Digite o valor do ataque do Guerreiro (máximo " + maxPoints + "):");
            if (scanner.hasNextInt()) {
            ...
            System.out.println("Digite o valor do ataque especial do Guerreiro (máximo " + maxPoints + "):");
            if (scanner.hasNextInt()) {
