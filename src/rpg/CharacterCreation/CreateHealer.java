...
public class CreateHealer {
    public static Healer createHealer(Scanner scanner) {
        ...
        do {
            ...
            slowConsole.imprimirDevagar("Digite o valor da vida inicial do Curandeiro (restantes " + maxPoints + "):");
            ...
            slowConsole.imprimirDevagar("Digite o valor do ataque do Curandeiro (restantes " + maxPoints + "):");
            if (scanner.hasNextInt()) {
            ...
            slowConsole.imprimirDevagar("Digite o valor do ataque especial do Curandeiro (restantes " + maxPoints + "):");
            if (scanner.hasNextInt()) {
            ...
            slowConsole.imprimirDevagar("Digite o valor da mana do Curandeiro (restantes " + maxPoints + "):");
            if (scanner.hasNextInt()) {
