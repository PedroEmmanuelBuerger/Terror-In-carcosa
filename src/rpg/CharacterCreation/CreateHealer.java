...
public class CreateHealer {
    public static Healer createHealer(Scanner scanner) {
        ...
        do {
            ...
            System.out.println("Digite o valor do ataque do Curandeiro (restantes " + maxPoints + "):");
            if (scanner.hasNextInt()) {
            ...
            System.out.println("Digite o valor do ataque especial do Curandeiro (restantes " + maxPoints + "):");
            if (scanner.hasNextInt()) {
            ...
            System.out.println("Digite o valor da mana do Curandeiro (restantes " + maxPoints + "):");
            if (scanner.hasNextInt()) {
